...
#include <memory>
#include "../../../AmongusJumper/src/gamescene.h"
...
QT_MOC_LITERAL(1, 10, 18), // "spriteAddedToScene"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7), // "Sprite*"
QT_MOC_LITERAL(4, 38, 7), // "pSprite"
QT_MOC_LITERAL(5, 46, 22), // "spriteRemovedFromScene"
QT_MOC_LITERAL(6, 69, 17) // "onSpriteDestroyed"

    },
    "GameScene\0spriteAddedToScene\0\0Sprite*\0"
    "pSprite\0spriteRemovedFromScene\0"
    "onSpriteDestroyed"
};
...
void GameScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->spriteAddedToScene((*reinterpret_cast< Sprite*(*)>(_a[1]))); break;
        case 1: _t->spriteRemovedFromScene((*reinterpret_cast< Sprite*(*)>(_a[1]))); break;
        case 2: _t->onSpriteDestroyed((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GameScene::*)(Sprite * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameScene::spriteAddedToScene)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GameScene::*)(Sprite * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameScene::spriteRemovedFromScene)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void GameScene::spriteAddedToScene(Sprite * _t1)
{
...
// SIGNAL 1
void GameScene::spriteRemovedFromScene(Sprite * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
